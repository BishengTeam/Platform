        ...
        <ScrollView className={styles.body} scrollY>
          ...
          <View className={styles.section}>
            ...
            <View className={styles.priceCard}>
              <PriceRow label={STRINGS.FORM_PRICE_EXAM_FEE} amount={cert.price} />
              {couponDiscount < 0 && (
                <PriceRow label={STRINGS.FORM_PRICE_COUPON_DISCOUNT} amount={couponDiscount} />
              )}
              <View className={styles.divider} />
              <PriceRow label={STRINGS.FORM_PRICE_TOTAL} amount={totalPrice} highlight />
            </View>
          </View>
