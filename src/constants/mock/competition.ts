...
export const ongoingCompetitions: Competition[] = [
  ...
  { id: 2, title: '华为ICT大赛2024', description: '华为官方举办的全球性ICT技术竞赛，获奖可获得华为就业绿色通道', prize: '总奖金¥2xx万', startTime: '2024-05-15', endTime: '2024-06-20', status: STRINGS.COMPETITION_STATUS_REGISTERING },
  { id: 3, title: '网络安全攻防大赛', description: '实战型网络安全竞赛，考验真实攻防能力', prize: '总奖金¥5x万', startTime: '2024-04-25', endTime: '2024-04-27', status: STRINGS.COMPETITION_ONGOING },
]
...
export const endedCompetitions: Competition[] = [
  { id: 6, title: '2023网络安全挑战赛', description: '2023年度网络安全技术挑战赛', prize: '总奖金¥6x万', startTime: '2023-12-01', endTime: '2023-12-15', status: STRINGS.COMPETITION_ENDED },
  { id: 7, title: '华为ICT大赛2023', description: '2023年度华为ICT技术竞赛', prize: '总奖金¥1xx万', startTime: '2023-11-01', endTime: '2023-11-20', status: STRINGS.COMPETITION_ENDED },
]
