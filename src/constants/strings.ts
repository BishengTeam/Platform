export const STRINGS = {
  ...
  IDENTITY_PENDING_TITLE: '实名认证审核中',
  IDENTITY_PENDING_DESC: '您的个人资料正在审核，请联系工作人员',
  IDENTITY_REJECTED_TITLE: '实名认证未通过',
  IDENTITY_REJECTED_DESC: '您的个人资料未通过审核',
  IDENTITY_RETRY_SUBMIT: '重新提交',
  ...
  ORDERS_STATUS_PAID: '已支付',
  ORDERS_STATUS_COMPLETED: '已完成',
  ORDERS_STATUS_REFUNDED: '已退款',
  ORDERS_STATUS_CLOSED: '已关闭',
  ...
  MINE_EXAM_QUERY_TITLE: '成绩查询',
  MINE_EXAM_QUERY_LINK: '查看成绩',
  MINE_EXAM_QUERY_EMPTY: '暂无成绩记录',
  MINE_EXAM_QUERY_STATUS_REGISTERED: '已报名',
  ...
  MINE_AGREEMENTS_VERSION: '版本',
  MINE_AGREEMENTS_EMPTY: '暂无签署记录',
  MINE_AGREEMENTS_LOAD_FAILED: '加载失败，请稍后重试',
  MINE_AGREEMENTS_STATUS_SIGNED: '已签署',
  MINE_AGREEMENTS_STATUS_UNSIGNED: '未签署',
  MINE_AGREEMENTS_STATUS_OUTDATED: '待更新签署',
  MINE_AGREEMENTS_NONE_CONFIGURED: '暂无已配置的协议',
  MINE_IDENTITY_AGREEMENT_BANNER_DESC: '您已完成实名认证，请阅读并签署最新版授权协议',
  AGREEMENT_TITLE_FALLBACK: '协议',
  AGREEMENT_TYPE_IDENTITY_AUTH: '实名信息授权协议',
  AGREEMENT_TYPE_CERT_REGISTRATION: '认证报名信息处理授权协议',
  AGREEMENT_LOADING: '加载中...',
  AGREEMENT_NOT_CONFIGURED: '协议暂未配置',
  AGREEMENT_VERSION: '当前版本',
  AGREEMENT_SIGN_AGREE: '我已阅读并同意',
  AGREEMENT_SIGN_SUBMIT: '同意并签署',
  AGREEMENT_SIGN_SUCCESS: '签署成功',
  AGREEMENT_SIGN_FAILED: '签署失败，请重试',
