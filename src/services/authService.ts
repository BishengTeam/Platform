...
export async function submitIdentity(data: {
  ...
  if (USE_MOCK) {
    return {
      ...
      id_card_front_oss: data.id_card_front_oss || 'renshe/source/1/mock-front.jpg',
      id_card_back_oss: data.id_card_back_oss || 'renshe/source/1/mock-back.jpg',
      avatar_oss: data.avatar_oss || 'renshe/source/1/mock-portrait.jpg',
      political_status: data.political_status || '群众',
...
export async function getIdentityStatus(): Promise<IdentityInfo> {
  if (USE_MOCK) {
    return {
      ...
      id_card_front_oss: 'renshe/source/1/mock-front.jpg',
      id_card_back_oss: 'renshe/source/1/mock-back.jpg',
      avatar_oss: 'renshe/source/1/mock-portrait.jpg',
      political_status: '群众',
      ethnicity: '汉族',
      status: 'verified',
      reject_reason: null,
