...
export {
  ...
  getFavoriteQuestions, getCheckinRecords, addWrongBook,
  removeWrongBook, submitQuizAnswer,
} from './quizService'
...
export {
  ...
  getNispPinyin, getNispTemplate, exportCertRegistrations,
  claimPoints, redeemPoints, getPrices,
  addCollection, removeCollection,
  getActivities, registerActivity, exportActivityRegistrations,
  getCompetitionStats, getCompetitionTracks, exportCompetitionRegistrations,
